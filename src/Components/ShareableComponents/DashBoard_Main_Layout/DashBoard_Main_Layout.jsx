...
const DashBoard_Main_Layout = ({ items,onItemClick  }) => {
    ...
    <div class="flex items-center justify-between">
      <div class="flex items-center justify-start rtl:justify-end">
        ...
        <a href="https://.com" class="flex ms-2 md:me-24">
          ...
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white transition-all duration-500 animate-pulse">SBXMoney</span>
        </a>
      </div>
          ...
          <div class="flex items-center ms-3">
            <div>
              <button type="button" class="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
                ...
                <img class="w-8 h-8 rounded-full" width={50} height={50} src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo"/>
              </button>
            </div>
...
export default DashBoard_Main_Layout
