  ...
  return (
    <>
      <section id="features" class=" px-4 space-y-6 bg-[#CDFFDB] py-8 dark:bg-transparent md:py-12 lg:py-20">
        ...
        {/* <div class="container mx-auto flex max-w-[58rem]  items-center space-y-4 text-center">
          ...
          <div class="flex justify-between mb-16 py-5 max-w-2xl p-8">
            <motion.div initial={{ x: "-100vw", opacity: 0 }}
              ...
              <h2
                ...
                <span class="font-bold text-[#2DBE61]">preferred option for many</span>
              ...
              <div
                ...
                <div class="relative z-10 mx-auto max-w-md ">
                  ...
                  <div class="pt-5 text-base font-semibold leading-7">
                    <p>
                      <a class="text-green-500 flex items-center group-hover:text-white/90" href="/">
                        More about Competitive Technology
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="h-5 w-5"
                          viewBox="0 0 20 20"
