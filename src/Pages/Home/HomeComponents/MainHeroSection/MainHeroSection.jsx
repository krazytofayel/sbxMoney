...
const MainHeroSection = () => {
  return (
    <>
      <section className='bg-[#CDFFDB]'>
        <div class=" container mx-auto grid grid-cols-1 md:grid-cols-2">
          <div class="">
            <div class="hero-content" data-speed="0.06" data-revert="true">
              <span data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200" class="aos-init aos-animate">FAST &amp; HASTLE FREE</span>
              <h1 data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300" class="aos-init aos-animate">The Most Powerful Money Exchange Service In The World</h1>
              <p data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400" class="aos-init aos-animate">It is a long established fact that a reader will be distracted by the reale he point of using Lorem Ipsum is that it has a more-or-less normal valid equity.</p>
              <a href="contact.html" class="btn style1 aos-init aos-animate" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">CONTACT US<i class="ri-arrow-right-s-line"></i></a>
            </div>
          </div>
          <div class="">
            <div class="hero-currency-convert relative mx-auto">
              {/* form */}
              <div class="w-11/12 p-12 bg-white shadow-xl sm:w-8/12 md:w-8/12 absolute">
              ...
              <div class="hero-currency-img aos-init aos-animate" >
                <img src="/src/assets/Vector1.png" alt="Image" className='w-full' />
              </div>
            </div>
          </div>
        </div>
