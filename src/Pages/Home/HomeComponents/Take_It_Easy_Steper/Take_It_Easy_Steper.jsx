      ...
      <section class="bg-[#f6f8f7] py-12 sm:py-16 lg:py-20 xl:py-24">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="relative container flex flex-col justify-between items-center  px-4 mx-auto md:flex-row sm:px-6 ">
            <div class="flex justify-between mb-16 py-5 max-w-2xl p-8 container">
          ...
          <ul class="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li class="flex-start group relative flex lg:flex-col">
              <span
                class="absolute left-[18px] lg:hidden top-14 h-[calc(100%_-_32px)] w-px bg-gray-300 lg:right-0 lg:left-auto lg:top-[18px] lg:h-px lg:w-[calc(100%_-_72px)]"
