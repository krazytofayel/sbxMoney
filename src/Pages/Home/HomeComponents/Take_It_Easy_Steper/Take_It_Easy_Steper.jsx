...
const Take_It_Easy_Steper = () => {
  return (
    <>
      <section class="bg-[#f6f8f7] py-12 sm:py-16 lg:py-20 xl:py-24">

        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="relative container flex flex-col justify-between items-center  px-4 mx-auto md:flex-row sm:px-6 ">
            <div class="flex justify-between  md:mb-16 py-5 max-w-2xl p-8 ">
              <motion.div initial={{ x: "-100vw", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ ease: "easeInOut", duration: 1 }} class="text-center md:text-left">
            ...
            <motion.div initial={{ x: "100vw", opacity: 0 }}
              animate={{ x: 0, opacity: 1 }}
              transition={{ ease: "easeInOut", duration: 1 }} class="md:text-left text-center">
              <h2 class="text-2xl font-extrabold leading-10 tracking-tight text-[#2DBE61] ">How it works?</h2>
          ...
          <ul class="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
            <li class="flex-start group relative flex lg:flex-col">
              <span
                class="absolute left-[18px] lg:hidden top-16 h-[calc(100%_-_32px)] w-px bg-gray-300 lg:right-0 lg:left-auto lg:top-[18px] lg:h-px lg:w-[calc(100%_-_72px)]"
                aria-hidden="true"></span>
              <div class="absolute  hidden lg:inline-block   lg:right-0 lg:left-auto lg:h-px">
                <img src="/src/assets/VectorUp.png" alt="Image Alt Text" />
              </div>
              <div
                class="inline-flex h-10 w-10 md:h-16 md:w-16 shrink-0 items-center justify-center rounded-xl border border-gray-300 bg-gray-50 transition-all duration-200 group-hover:border-green-400 group-hover:bg-green-400">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5 md:h-10 md:w-10 text-gray-600 group-hover:text-white">
                  <path
              ...
              <div class="ml-6 lg:ml-0 lg:mt-10">
                <h3
                  class="text-xl font-bold text-green-500 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">
                  Register for Free
                </h3>
            ...
            <li class="flex-start group relative flex lg:flex-col">
              <span
                class="absolute left-[18px] lg:hidden top-16 h-[calc(100%_-_32px)] w-px bg-gray-300 lg:right-0 lg:left-auto lg:top-[18px] lg:h-px lg:w-[calc(100%_-_72px)]"
                aria-hidden="true"></span>
              <div class="absolute  hidden lg:inline-block top-5  lg:right-0 lg:left-auto lg:h-px">
