...
const Contact_Us_Address_Card = () => {
  return (
    <>
      <section
        id="features"
        class=" px-4 space-y-6  bg-gradient-to-t from-[#cdffdb] to-transparent py-8 dark:bg-transparent md:py-12 lg:py-20"
      >
        <div class="relative container flex flex-col justify-between items-center  px-4 mx-auto md:flex-row sm:px-6 ">
          <div class="flex justify-between mb-16 py-5 max-w-2xl p-8">
            <div class="text-left">
              <h2 class="text-2xl font-extrabold leading-10 tracking-tight text-gray-800 sm:text-5xl sm:leading-none md:text-4xl">
                Let's
          ...
          <div class="text-left -mt-14">
            <h2 class="text-2xl font-extrabold leading-10 tracking-tight text-[#2DBE61] ">
              Our BD Agent
            </h2>
            <p class="max-w-md mx-auto  text-base text-gray-500 sm:text-lg  md:text-xl md:max-w-3xl">
              text with We are your gateway to a world of seamless international
              money transfers.
            </p>
          </div>
        </div>
