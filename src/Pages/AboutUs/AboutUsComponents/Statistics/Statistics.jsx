      ...
      <div className='bg-gradient-to-t from-[#cdffdb] to-transparent '>
        ...
        <div className="flex justify-center items-center ">
          <div className="grid grid-cols-1 md:grid-cols-3  xl:grid-cols-5 gap-4 mb-10 mt-5">
            <AnimatedStatsCard title="Download" value="100000" icon={<FaDownload className="text-white" />} />
            <AnimatedStatsCard title="Feedback" value="1000" icon={<FaFileSignature className="text-white" />} />
            <AnimatedStatsCard title="Worker" value="300" icon={<FaUserTie className="text-white" />} />
            <AnimatedStatsCard title="Years Of Experience" value="10" icon={<FaCalendarAlt className="text-white" />} />
