...
import signinimg from '../../../../src/assets/gridimg1.jpg'
  ...
  return (
    <>
      ...
      <section className="min-h-screen flex items-stretch text-black ">
        ...
        <div
          className="lg:flex z-10  w-1/2 hidden bg-gray-100 bg-no-repeat bg-cover relative items-center text-white"
        ...
        <div className="lg:w-1/2 w-full flex items-center justify-center text-center xl:px-16 md:px-6 px-0 z-0 bg-[#f5f4ef]">
          ...
          <div className="w-full py-6 pb-10 z-20 ">
            ...
            <form action="" className="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
              ...
              <p className=" mt-2 mb-2">Dont have an account yet? <Link to="/sign_up" className="text-[#2C6777] font-medium">Sign up</Link> </p>
